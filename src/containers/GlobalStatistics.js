...
import { GlobalStatistics } from 'components'

class GlobalStatisticsContainer extends Component {
  static propTypes = {
...
export default withServerState(connect(mapStateToProps, mapDispatchToProps)(GlobalStatisticsContainer))
